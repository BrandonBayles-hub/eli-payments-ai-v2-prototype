...
export default function EliOnboardingHybrid() {
  ...
  const allPageIds: PageId[] = ["overview", "company", "privacy", "email", "communications", "leasing", "payments", "payments-advanced", "maintenance", "renewals", "renewals-channels", "golive"]

...
export const NEEDS_ATTENTION: NeedAttentionItem[] = [
  ...
  // ── Global (affects all products) ──────────────────────────────────────────
  {
    ...
    why: "8 properties are missing required SMS consent language in their privacy policy. Additionally, 3 properties use third-party websites and need an opt-in consent checkbox added to their contact forms before ELI+ can go live.",
    summary: "8 properties need privacy policy · 3 need third-party opt-in checkbox",
    severity: "critical",
    to: "privacy",
    product: "all",
